...
## ⚡ Technologies
Talk to me about
- Backend development using **C#, .Net Core, ASP.Net MVC, Entity framework, Azure Function, Microsoft Bot Framework**
- Front-end development using **Javascript, HTML, CSS, Bootstrap**
- Database using **SQL Server , CosmosDB, Azure Storage**
- Tools: **Git, Postman, VS, WinSCP, Teamcity, Jira**
